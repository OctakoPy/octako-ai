...
const WorkflowAutomation = () => (
  <ServicePageLayout
    ...
    subtitle="For when you're doing the same task over and over. Custom automation that eliminates repetitive work."
    accentColor="purple"
    icon={Network}
    ...
    howItWorks={[
      { title: "Describe your task", detail: "Share what you're doing manually and how often" },
      { title: "Assessment and quote", detail: "Same-day evaluation of automation potential with clear pricing" },
      { title: "Build your solution", detail: "Custom automation solution tailored to your exact workflow" },
      { title: "You review and launch", detail: "Test with real data, make adjustments, and go live" },
    ]}
    exampleResult="Results: 12 hours/week compiling sales reports reduced to 20 minutes reviewing auto-generated dashboards"
