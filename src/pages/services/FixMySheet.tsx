...
const FixMySheet = () => (
  <ServicePageLayout
    title="FixMySheet"
    subtitle="For when Excel is your enemy. We fix broken spreadsheets and build ones that actually work."
    accentColor="green"
    icon={Table}
    whatThisIs="FixMySheet is our fast-turnaround service for spreadsheet problems. Whether it's a broken formula, a spreadsheet that takes 5 minutes to open, or a manual process that should be automated—we fix it. Most fixes completed within 24-48 hours."
    whatWeBuild={{
      title: "What We Fix",
      items: [
    ...
    howItWorks={[
      { title: "Send us your spreadsheet", detail: "Upload or describe what you need fixed" },
      { title: "Same-day assessment", detail: "We review and quote a fixed price" },
      { title: "We fix it", detail: "Most fixes completed within 24-48 hours" },
