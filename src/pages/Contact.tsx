        ...
        <div className="section-container relative z-10 max-w-4xl">
          <AnimateIn>
            ...
            <p className="text-body-lg text-white/70 max-w-2xl">
              Share your workflow challenge and get a clear path forward.
            </p>
          </AnimateIn>
        </div>
      </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="rounded-xl border border-border bg-surface p-8 hover:border-accent-cyan hover:shadow-lg transition-all group">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Email your workflow challenge and get a response within 24 hours.
                </p>
          ...
          <AnimateIn>
            <div className="rounded-xl border-2 border-accent-purple/30 bg-gradient-to-br from-accent-purple/5 to-accent-pink/5 p-8 md:p-12 text-center">
              ...
              <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
                Just tell us what's eating into your day. You'll get an honest assessment of solutions available and the best approach to take. No pressure, no sales pitch—just real advice.
              </p>
